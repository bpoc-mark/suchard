    ...
    <section class="sect_2">
        <div class="sect_2__wrapper">
            <div class="l-wrap">
                ...
                <!-- Title -->
                <h3 class="heading-title heading-title-primary wrap">スシャールメニュー</h3>
                        ...
                        <div class="mt-55" style="position: relative;">
                            ...
                            <div class="accordion_item">
                                ...
                                <div class="content">
                                    ...
                                    <p class="btm-desc sp">※アイスコーヒー 共に＋¥50</p>
                                </div>
                                <div class="flex pc">
                                    <div class="col_img">
                                        <img src="<?php echo get_template_directory_uri(); ?>/release/image/sect_2/sect_2_img_1.png"
                                ...
                                <p class="btm-desc min-tp pc">※アイスコーヒー 共に＋¥50</p>
                            </div>
                        </div>
                            ...
                            <div class="accordion_item">
                                ...
                                <div class="content">
                                    ...
                                    <div class="wrap">
                                        ...
                                        <p class="sub-title ls-2">バタートースト、ジャムトーストは<br class="br_pc"><br
                                                class="br_sp">単品のみご注文可。
                                        </p>
                                        <div class="flex mb-48 pc">
                                            <div class="col_img_1">
